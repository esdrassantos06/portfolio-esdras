...
export default function LocaleSwitcher() {
  ...
  return (
    <Select value={locale} onValueChange={handleLanguageChange}>
      ...
      <SelectContent className="text-principal relative z-[999999] overflow-hidden rounded-xl border border-gray-200/30 bg-gradient-to-b from-white/5 to-transparent p-1 shadow-xl backdrop-blur-md">
        <SelectGroup>
